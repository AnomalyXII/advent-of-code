...
public record Velocity(int h, int v) {
    ...
    /**
     * Create a new {@link Velocity} by parsing the given {@code (h,v)}
     * {@link String}.
     *
     * @param velocity the velocity
     * @return the {@link Coordinate}
     */
    public static Velocity parse(final String velocity) {
        final String[] hv = velocity.split(",", 2);
        return new Velocity(Integer.parseInt(hv[0]), Integer.parseInt(hv[1]));
    }
