...
class Day16Test {
    ...
    private static final SolutionContext EXAMPLE = SolutionContext.example(2020, 16);
    private static final SolutionContext EXAMPLE_2 = SolutionContext.example(2020, 16, 2);
