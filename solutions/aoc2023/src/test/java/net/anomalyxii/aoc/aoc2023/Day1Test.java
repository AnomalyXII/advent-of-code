...
class Day1Test {
    ...
    private static final SolutionContext EXAMPLE = SolutionContext.example(2023, 1);
    private static final SolutionContext EXAMPLE_2 = SolutionContext.example(2023, 1, 2);
